...
public class Ex01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("O mês com a maior temperatura foi: "+mes[maiorMes]+ "com média de: "+maiorTemp);
		System.out.println("O mes com a menor temperatura foi: "+mes[menorMes]+ "com média de: "+menorTemp);
