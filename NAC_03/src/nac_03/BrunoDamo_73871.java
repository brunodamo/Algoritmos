...
public class BrunoDamo_73871 {
	...
	public static void main(String[] args) {
		...
		while (venda=='S'){
			System.out.println("_________Venda nº"+i+"_________");
			...
			while  ((condicao.equalsIgnoreCase(condicao) != condicao.equalsIgnoreCase("FV")) && (condicao.equalsIgnoreCase(condicao) !=condicao.equalsIgnoreCase("FP"))){
				System.out.println("Insira uma forma de pagamento inválida !");
				System.out.println("Digite a forma de Pagamento: FV - Vista e FP - Prazo");
				condicao = entrada.next();
			}
			if (condicao.equalsIgnoreCase("FV")){
				...
				for (parcela=2;parcela<14;parcela+=2){
					...
					System.out.println("O preço final parcelado em "+parcela+"X é de "+formata.format(totalParcela)+" com parcelas de "+formata.format(totalParcela/parcela));
				}
			...
			System.out.println("Deseja cadastrar uma nova venda ? S- Sim, N- Não");
			...
			if (venda=='N'){
				System.out.println("RELATÓRIO FINAL MAGAZINE LUIZA");
				System.out.println("Número de vendas realizadas: "+i);
				System.out.println("Número de vendas à Vista: "+iVista*100/i+"%");
				System.out.println("Número de vendas à Prazo: "+iPrazo*100/i+"%");
			}
