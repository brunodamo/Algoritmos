...
public class Ex01 {
	...
	public static void main(String[] args) {
		...
		//Atribuiir valores às variáveis
		idade=0;
		contador=0;
		qtd1=0;
		qtd2=0;
		...
		System.out.println("Quantidade de pessoas com idade superior a 50 anos: " + qtd1);
		if (qtd2 !=0){
		System.out.println("A média das alturas das pessoas com idade entre 10 e 20: " + totAltura/qtd2);
		}
		System.out.println("A porcentagem de pessoas com peso inferior 40 quilos: " + (totPeso/5)*100 + "%");
