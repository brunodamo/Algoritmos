...
public class Ex11 {
	...
	public static void main(String[] args) {
		...
		System.out.println("O valor à vista é: "+valorDesc);	
		for (i=6;i<=60;i+=6){
			parcela+=3;
			total=valorCarro+(valorCarro*parcela/100);
			System.out.println("O preco final parcelado em "+i+"X vezes é de "+numFormatado.format(total)+ " com parcelas de R$: "+numFormatado.format(total/i));
